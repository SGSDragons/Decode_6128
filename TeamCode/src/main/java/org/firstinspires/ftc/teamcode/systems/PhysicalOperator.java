...
public class PhysicalOperator {
    ...
    final double shooterTargetVelocity;
    final double shooterVelocityMinRange;

    public PhysicalOperator(HardwareMap hardwareMap) {
    ...
    public void Operate(Gamepad gamepad1, Gamepad gamepad2, boolean plot) {
